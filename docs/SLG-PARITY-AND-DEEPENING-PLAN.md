...
- ◑ **Phase 3 — deploy ergonomics:** `edge.yaml` done; per-agent SAM golden-path folders remaining.
- ◑ **Phase 6 — hygiene:** VERSION/SOURCES.md/CHANGELOG.md done; combined deck + leave-behinds (Phase 5) remaining.
