...
|---|---|---|
| **02 Pharmacovigilance (hero)** | Safety DB — **openFDA / FAERS** (public) | **3 · live reference** (read-only) |
| 02 Pharmacovigilance | Safety DB — Argus / Veeva Safety (customer) | **4 · not done** (engagement) |
| 02 Pharmacovigilance | Safety DB — local HTTP reference (`demo/demo_live.py`) | 2 · local HTTP stand-in |
| 01, 03–09 | RIM, DMS, EDC, CTMS, eTMF, QMS, MES/LIMS, CRM | 1 · fixture (tier 4 = engagement) |
