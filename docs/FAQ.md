...
is how the **492 automated tests** pass and how you demo before any account exists.
...
**or** managed AgentCore) + the native/container agent — in any Region. Terraform parity is provided.
