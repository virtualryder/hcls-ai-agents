...
The suite is **Demonstrated + Deployable-by-design**: the control plane runs, 583 tests pass with no API
...
- 583 automated tests (incl. governance + red-team + the withholding test), run in one command via `make test`.
