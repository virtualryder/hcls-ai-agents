...
The suite is **Demonstrated + Deployable-by-design**: the control plane runs, 575 tests pass with no API
...
- 575 automated tests (incl. governance + red-team + the withholding test), run in one command via `make test`.
