...
| How do you test reliability? | 575 tests covering agent graphs, gateway enforcement, connector modes; DR runbook with tested procedures | `runbooks/DR-RUNBOOK.md` |
...
| How do you benchmark and test performance? | 575 automated tests; demo path runs full workflow without API spend; latency measured per graph node via OpenTelemetry |
