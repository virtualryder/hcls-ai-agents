#!/usr/bin/env python3
"""Reviewer STAND-IN for the 07-rwe-heor smoke test (the deployed reviewer service is the next delivery step).
...
out = {"approved": True, "decision": "APPROVE", "reviewer": {"sub": approver, "custom:hcls_role": "EPIDEMIOLOGIST"}}  # read/draft-only: no bound write tool
