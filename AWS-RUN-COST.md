# AWS Run-Cost Model — HCLS / Life Sciences
...
below is for **Agent 02 (Pharmacovigilance)** at pilot scale.*
...
with real figures from the Pricing Calculator**. Data class for this pack: PHI (HealthLake variant) → PrivateLink required.
